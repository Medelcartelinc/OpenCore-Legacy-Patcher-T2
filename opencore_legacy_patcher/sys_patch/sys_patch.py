...
<<<<<<< HEAD
        # Fatal: continuing would rebuild kernel collections and seal a snapshot with a
        # kext that cannot link (or has an invalid signature), reporting success with no audio.
=======
