...
class BuildFirmware:
    ...
    def _apple_logo_handling(self) -> None:
        ...
        if smbios_data.smbios_dictionary[self.model]["Max OS Supported"] >= os_data.os_data.monterey and self.model not in ["MacPro6,1", "Macmini7,1", "MacBookAir8,1", "MacBookAir8,2", "MacBookAir9,1", "MacBookAir9,2", "MacBookPro15,1", "MacBookPro15,2", "MacBookPro15,3", "MacBookPro15,4", "MacBookPro16,3", "MacBookPro16,4", "Macmini8,1", "iMacPro1,1"]:
