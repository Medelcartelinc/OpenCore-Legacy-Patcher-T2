...
class MainFrame(wx.Frame):
    ...
    def _check_for_updates(self, manual: bool = False):
        ...
        try:
            response = requests.get(url, headers={"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/153.0.0.0 Safari/537.36 Edg/153.0.0.0/OpenCoreLegacyPatcherT2"}, timeout=10).json()
            if "body" in response:
